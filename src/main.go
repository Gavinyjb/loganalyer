...
func main() {
	...
	//01
	//srcpath01 := flag.String("srcpath", "/Users/gavin/Desktop/loganalyer-master/logs/01-src/slave2", "log日志路径")
	//
	////--------02
	////srcpath02 := flag.String("srcpath", "/Users/gavin/Desktop/loganalyer-master/logs/02-src/", "json文件所在目录")
	...
	////05
	kvFilePath := "/Users/gavin/Desktop/loganalyer-master/logs/01-src/slave1/JsonOut/extract/hadoop-root-datanode-slave1_rKV.json"
